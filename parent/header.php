                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-heading"><span class="sidebar-mini-visible">CH</span><span class="sidebar-mini-hidden">CHILD MENU</span></li>
                            <li>
                                <a href="child.php"><i class="si si-user-follow"></i><span class="sidebar-mini-hide">Add Child</span></a>
                            </li>
                            <li>
                                <a href="./viewchild.php"><i class="si si-eye"></i><span class="sidebar-mini-hide">View Child</span></a>
                            </li>
